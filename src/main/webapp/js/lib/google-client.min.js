var gapi=window.gapi=window.gapi||{};gapi._bs=new Date().getTime();(function(){var aa=encodeURIComponent,k=window,ba=Object,q=document,ca=Array,da=parseInt,r=String,ea=decodeURIComponent;function fa(a,b){return a.type=b}
    ...
    Function[J].bind=Function[J][na]||function(a,b){if(1<arguments[I]){var c=ca[J].slice[L](arguments,1);c.unshift(this,a);return Ia[E](null,c)}return Ia(this,a)};var O=k,P=q,Ja=O[B],Ka=function(){},La=/\[native code\]/,Q=function(a,b,c){return a[b]=a[b]||c},Ma=function(a){for(var b=0;b<this[I];b++)if(this[b]===a)return b;return-1},Na=function(a){a=a.sort();for(var b=[],c=void 0,d=0;d<a[I];d++){var e=a[d];e!=c&&b[F](e);c=e}return b},Oa=/&/g,Pa=/</g,Qa=/>/g,Ra=/"/g,Sa=/'/g,Ta=function(a){return r(a)[t](Oa,"&amp;")[t](Pa,"&lt;")[t](Qa,"&gt;")[t](Ra,"&quot;")[t](Sa,"&#39;")},R=function(){var a;if((a=ba.create)&&La[G](a))a=a(null);else{a={};for(var b in a)a[b]=
        void 0}return a},S=function(a,b){return ba[J].hasOwnProperty[L](a,b)},Ua=function(a){if(La[G](ba.keys))return ba.keys(a);var b=[],c;for(c in a)S(a,c)&&b[F](c);return b},T=function(a,b){a=a||{};for(var c in a)S(a,c)&&(b[c]=a[c])},Va=function(a){return function(){O.setTimeout(a,0)}},Wa=function(a,b){if(!a)throw Error(b||"");},U=Q(O,"gapi",{});var V=function(a,b,c){var d=new RegExp("([#].*&|[#])"+b+"=([^&#]*)","g");b=new RegExp("([?#].*&|[?#])"+b+"=([^&#]*)","g");if(a=a&&(d[ia](a)||b[ia](a)))try{c=ea(a[2])}catch(e){}return c},Xa=/^([^?#]*)(\?([^#]*))?(\#(.*))?$/,Ya=function(a){a=a[ma](Xa);var b=R();b.H=a[1];b.j=a[3]?[a[3]]:[];b.o=a[5]?[a[5]]:[];return b},Za=function(a){return a.H+(0<a.j[I]?"?"+a.j[N]("&"):"")+(0<a.o[I]?"#"+a.o[N]("&"):"")},$a=function(a,b){var c=[];if(a)for(var d in a)if(S(a,d)&&null!=a[d]){var e=b?b(a[d]):a[d];c[F](aa(d)+
    ...
    xb.m=function(a,b,c,d){(a=a[0])||X("missing_hint");return"https://apis.google.com"+Jb(a,b,c,d)};var Mb=decodeURI("%73cript"),Nb=function(a,b){for(var c=[],d=0;d<a[I];++d){var e=a[d];e&&0>Ma[L](b,e)&&c[F](e)}return c},Pb=function(a){"loading"!=P.readyState?Ob(a):P.write("<"+Mb+' src="'+encodeURI(a)+'"></'+Mb+">")},Ob=function(a){var b=P[u](Mb);b[w]("src",a);b.async="true";(a=P[pa](Mb)[0])?a[M].insertBefore(b,a):(P.head||P.body||P.documentElement)[ga](b)},Qb=function(a,b){var c=b&&b._c;if(c)for(var d=0;d<yb[I];d++){var e=yb[d][0],f=yb[d][1];f&&S(c,e)&&f(c[e],a,b)}},Sb=function(a,b){Rb(function(){var c;
        c=b===kb(Ja[C])?Q(U,"_",R()):R();c=Q(pb(b),"_",c);a(c)})},Ub=function(a,b){var c=b||{};"function"==typeof b&&(c={},c.callback=b);Qb(a,c);var d=a?a[A](":"):[],e=c.h||Lb(),f=Q(W,"ah",R());if(f["::"]&&d[I]){for(var g=[],h=null;h=d[ha]();){var l=h[A]("."),l=f[h]||f[l[1]&&"ns:"+l[0]||""]||e,n=g[I]&&g[g[I]-1]||null,m=n;n&&n.hint==l||(m={hint:l,N:[]},g[F](m));m.N[F](h)}var p=g[I];if(1<p){var x=c.callback;x&&(c.callback=function(){0==--p&&x()})}for(;d=g[ha]();)Tb(d.N,c,d.hint)}else Tb(d||[],c,e)},Tb=function(a,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  b,c){a=Na(a)||[];var d=b.callback,e=b.config,f=b.timeout,g=b.ontimeout,h=null,l=!1;if(f&&!g||!f&&g)throw"Timeout requires both the timeout parameter and ontimeout parameter to be set";var n=Q(pb(c),"r",[]).sort(),m=Q(pb(c),"L",[]).sort(),p=[][ka](n),x=function(a,b){if(l)return 0;O.clearTimeout(h);m[F][E](m,D);var d=((U||{}).config||{})[Ea];d?d(e):e&&Q(W,"cu",[])[F](e);if(b){wb("me0",a,p);try{Sb(b,c)}finally{wb("me1",a,p)}}return 1};0<f&&(h=O.setTimeout(function(){l=!0;g()},f));var D=Nb(a,m);if(D[I]){var D=
        Nb(a,n),v=Q(W,"CP",[]),K=v[I];v[K]=function(a){if(!a)return 0;wb("ml1",D,p);var b=function(b){v[K]=null;x(D,a)&&ob(function(){d&&d();b()})},c=function(){var a=v[K+1];a&&a()};0<K&&v[K-1]?v[K]=function(){b(c)}:b(c)};if(D[I]){var nb="loaded_"+W.I++;U[nb]=function(a){v[K](a);U[nb]=null};a=Gb(c,D,"gapi."+nb,n);n[F][E](n,D);wb("ml0",D,p);b.sync||O.___gapisync?Pb(a):Ob(a)}else v[K](Ka)}else x(D)&&d&&d()};var Rb=function(a){if(W.hee&&0<W.hel)try{return a()}catch(b){W.hel--,Ub("debug_error",function(){try{k.___jsl.hefn(b)}catch(a){throw b;}})}else return a()};U.load=function(a,b){return Rb(function(){return Ub(a,b)})};var Vb=function(a){var b=k.___jsl=k.___jsl||{};b[a]=b[a]||[];return b[a]},Wb=function(a){var b=k.___jsl=k.___jsl||{};b.cfg=!a&&b.cfg||{};return b.cfg},Xb=function(a){return"object"===typeof a&&/\[native code\]/[G](a[F])},Yb=function(a,b){if(b)for(var c in b)b.hasOwnProperty(c)&&(a[c]&&b[c]&&"object"===typeof a[c]&&"object"===typeof b[c]&&!Xb(a[c])&&!Xb(b[c])?Yb(a[c],b[c]):b[c]&&"object"===typeof b[c]?(a[c]=Xb(b[c])?[]:{},Yb(a[c],b[c])):a[c]=b[c])},Zb=function(a){if(a&&!/^\s+$/[G](a)){for(;0==a[Ba](a[I]-
    ...
    var xd=function(a,b){wd(void 0,!1,a,b)},wd=function(a,b,c,d){ub("ps0",!0);c=("string"===typeof c?q[va](c):c)||P;var e;e=P[Da];if(c.querySelectorAll&&(!e||8<e)){e=d?[d]:Ua(pd)[ka](Ua(qd))[ka](Ua(rd));for(var f=[],g=0;g<e[I];g++){var h=e[g];f[F](".g-"+h,"g\\:"+h)}e=c.querySelectorAll(f[N](","))}else e=c[pa]("*");c=R();for(f=0;f<e[I];f++){g=e[f];var l=g,h=d,n=l[xa][Fa](),m=void 0;l[Aa]("data-gapiscan")?h=null:(0==n[H]("g:")?m=n[y](2):(l=(l=r(l.className||l[Aa]("class")))&&ud[ia](l))&&(m=l[1]),h=!m||
        !(pd[m]||qd[m]||rd[m])||h&&m!==h?null:m);h&&(vd[h]||0==g[xa][Fa]()[H]("g:")||0!=Ua(md(g))[I])&&(g[w]("data-gapiscan",!0),Q(c,h,[])[F](g))}if(b)for(var p in c)for(b=c[p],d=0;d<b[I];d++)b[d][w]("data-onload",!0);for(var x in c)sd[F](x);ub("ps1",!0);if((p=sd[N](":"))||a)try{U.load(p,a)}catch(D){ic(D);return}if(yd(td||{}))for(var v in c){a=c[v];x=0;for(b=a[I];x<b;x++)a[x].removeAttribute("data-gapiscan");zd(v)}else{d=[];for(v in c)for(a=c[v],x=0,b=a[I];x<b;x++)e=a[x],Ad(v,e,md(e),d,b);Bd(p,d)}},Cd=function(a){var b=
        ...
        ad(c[h])}catch(l){delete c[h]}}var n=!0;c.dontclear&&(n=!1);delete c.dontclear;kc();f=jd(a,c,e);h={allowPost:1,attributes:gd};h.dontclear=!n;e={};e.userParams=c;e.url=f;fa(e,a);var m;c.rd?m=b:(m=q[u]("div"),b[w]("data-gapistub",!0),m[qa].cssText="position:absolute;width:450px;left:-10000px;",b[M].insertBefore(m,b));e.siteElement=m;m.id||(b=m,Q(id,a,0),n="___"+a+"_"+id[a]++,b.id=n);b=R();b[">type"]=a;T(c,b);n=f;c=m;f=h||{};b=f[ta]||{};Wa(!f.allowPost||!b.onload,"onload is not supported by post iframe");
        h=b=n;Qc[G](b)&&(h=Y("iframes/"+h[Ca](1)+"/url"),Wa(!!h,"Unknown iframe url config for - "+b));n=bb(P,h[t](Rc,Tc));b=c.ownerDocument||P;m=0;do h=f.id||["I",Nc++,"_",(new Date)[oa]()][N]("");while(b[va](h)&&5>++m);Wa(5>m,"Error creating iframe id");m={};var p={};b[Da]&&9>b[Da]&&(m.hostiemode=b[Da]);T(f.queryParams||{},m);T(f.fragmentParams||{},p);var x=f.connectWithQueryParams?m:p,D=f.pfname,v=R();v.id=h;v.parent=b[B][ra]+"//"+b[B].host;var K=V(b[B][C],"parent"),D=D||"";!D&&K&&(K=V(b[B][C],"id",""),
            D=V(b[B][C],"pfname",""),D=K?D+"/"+K:"");v.pfname=D;T(v,x);(v=V(n,"rpctoken")||m.rpctoken||p.rpctoken)||(v=x.rpctoken=f.rpctoken||r(Math.round(1E8*(xc?Gc():Fc()))));f.rpctoken=v;v=b[B][C];x=R();(K=V(v,"_bsh",W.bsh))&&(x._bsh=K);(v=kb(v))&&(x.jsh=v);f.hintInFragment?T(x,p):T(x,m);n=ab(n,m,p,f.paramsSerializer);p=R();T(Lc,p);T(f[ta],p);p.name=p.id=h;p.src=n;f.eurl=n;if((f||{}).allowPost&&2E3<n[I]){m=Ya(n);p.src="";p["data-postorigin"]=n;n=Pc(b,c,p,h);-1!=navigator.userAgent[H]("WebKit")&&(g=n.contentWindow.document,
            g.open(),p=g[u]("div"),x={},v=h+"_inner",x.name=v,x.src="",x.style="display:none",Pc(b,p,x,v,f));p=(f=m.j[0])?f[A]("&"):[];f=[];for(x=0;x<p[I];x++)v=p[x][A]("=",2),f[F]([ea(v[0]),ea(v[1])]);m.j=[];p=Za(m);m=b[u]("form");m.action=p;m.method="POST";m.target=h;m[qa].display="none";for(h=0;h<f[I];h++)p=b[u]("input"),fa(p,"hidden"),p.name=f[h][0],p.value=f[h][1],m[ga](p);c[ga](m);m.submit();m[M][za](m);g&&g.close();g=n}else g=Pc(b,c,p,h,f);e.iframeNode=g;e.id=g[Aa]("id");g=e.id;c=R();c.id=g;c.userParams=
        ...
        f);Bd(c,g)}else ic("string"==="gapi."+c+".render: missing element "+typeof a?a:"")};Q(U,"platform",{}).go=xd;var yd=function(a){for(var b=["_c","jsl","h"],c=0;c<b[I]&&a;c++)a=a[b[c]];b=kb(Ja[C]);return!a||0!=a[H]("n;")&&0!=b[H]("n;")&&a!==b},Bd=function(a,b){Hd(a,b)},fb=function(a){wd(a,!0)},Id=function(a,b){for(var c=b||[],d=0;d<c[I];++d)a(c[d]);for(d=0;d<c[I];d++)Cd(c[d])};
    yb[F](["platform",function(a,b,c){td=c;b&&sd[F](b);Id(Dd,a);Id(Ed,c._c.annotation);Id(Fd,c._c.bimodal);bc();$b();if("explicit"!=Y("parsetags")){lb(a);gc(fc())&&!Y("disableRealtimeCallback")&&kc();var d;c&&(a=c.callback)&&(d=Va(a),delete c.callback);hb(function(){fb(d)})}}]);U._pl=!0;var Jd=function(a){a=(a=Z[a])?a.oid:void 0;if(a){var b=P[va](a);b&&b[M][za](b);delete Z[a];Jd(a)}};var Kd=/^\{h\:'/,Ld=/^!_/,Md="",Hd=function(a,b){function c(){db("message",d,"remove","de")}function d(d){var g=d.data,h=d.origin;if(Nd(g,b)){var l=e;e=!1;l&&ub("rqe");Od(a,function(){l&&ub("rqd");c();for(var a=Q(W,"RPMQ",[]),b=0;b<a[I];b++)a[b]({data:g,origin:h})})}}if(0!==b[I]){Md=V(Ja[C],"pfname","");var e=!0;db("message",d,"add","at");Ub(a,c)}},Nd=function(a,b){a=r(a);if(Kd[G](a))return!0;var c=!1;Ld[G](a)&&(c=!0,a=a[y](2));if(!/^\{/[G](a))return!1;var d=bd(a);if(!d)return!1;var e=d.f;if(d.s&&
        ...
        l.fontSize="1px";l.verticalAlign="baseline";d=d[qa];d.display="inline-block";l=c[qa];l.position="static";l.left=0;l.top=0;l.visibility="visible";f&&(d.width=l.width=f+"px");h&&(d.height=l.height=h+"px");e.verticalAlign&&(d.verticalAlign=e.verticalAlign);g&&mc(g,3)}c["data-csi-wdt"]=(new Date)[oa]()}}return!0}return!1},Od=function(a,b){Ub(a,b)};var Pd=function(a,b){this.B=a;var c=b||{};this.S=c.X;this.A=c.domain;this.C=c.path;this.T=c.Y},Qd=/^[-+/_=.:|%&a-zA-Z0-9@]*$/,Rd=/^[A-Z_][A-Z0-9_]{0,63}$/;
    Pd[J].write=function(a,b){if(!Rd[G](this.B))throw"Invalid cookie name";if(!Qd[G](a))throw"Invalid cookie value";var c=this.B+"="+a;this.A&&(c+=";domain="+this.A);this.C&&(c+=";path="+this.C);var d="number"===typeof b?b:this.S;if(0<=d){var e=new Date;e.setSeconds(e.getSeconds()+d);c+=";expires="+e.toUTCString()}this.T&&(c+=";secure");q.cookie=c;return!0};Pd.iterate=function(a){for(var b=q.cookie[A](/;\s*/),c=0;c<b[I];++c){var d=b[c][A]("="),e=d[ha]();a(e,d[N]("="))}};var Sd=function(a){this.V=a},Td={};Sd[J].write=function(a){Td[this.V]=a;return!0};Sd.iterate=function(a){for(var b in Td)Td.hasOwnProperty(b)&&a(b,Td[b])};var Ud="https:"===k[B][ra],Vd=Ud||"http:"===k[B][ra]?Pd:Sd,Wd=function(a){var b=a[y](1),c="",d=k[B].hostname;if(""!==b){c=da(b,10);if(isNaN(c))return null;b=d[A](".");if(b[I]<c-1)return null;b[I]==c-1&&(d="."+d)}else d="";return{d:"S"==a[la](0),domain:d,i:c}},Xd=function(a){if(0!==a[H]("GCSC"))return null;var b={w:!1};a=a[y](4);if(!a)return b;var c=a[la](0);a=a[y](1);var d=a.lastIndexOf("_");if(-1==d)return b;var e=Wd(a[y](d+1));if(null==e)return b;a=a[Ca](0,d);if("_"!==a[la](0))return b;d="E"===
        c&&e.d;return!d&&("U"!==c||e.d)||d&&!Ud?b:{w:!0,d:d,W:a[y](1),domain:e.domain,i:e.i}},Yd=function(a){if(!a)return[];a=a[A]("=");return a[1]?a[1][A]("|"):[]},Zd=function(a){a=a[A](":");return{t:a[0][A]("=")[1],P:Yd(a[1]),$:Yd(a[2]),Z:Yd(a[3])}},$d=function(){var a,b=null;Vd.iterate(function(c,d){if(0===c[H]("G_AUTHUSER_")){var e=Wd(c[Ca](11));if(!a||e.d&&!a.d||e.d==a.d&&e.i>a.i)a=e,b=d}});if(null!==b){var c;Vd.iterate(function(b,d){var e=Xd(b);e&&e.w&&e.d==a.d&&e.i==a.i&&(c=d)});if(c){var d=Zd(c),
        e=d&&d.P[Number(b)],d=d&&d.t;if(e)return{Q:b,R:e,t:d}}}return null};var ae=function(a){this.G=a};ae[J].k=0;ae[J].F=2;ae[J].G=null;ae[J].v=!1;ae[J].M=function(){this.v||(this.k=0,this.v=!0,this.D())};ae[J].D=function(){this.v&&(this.G()?this.k=this.F:this.k=Math.min(2*(this.k||this.F),120),k.setTimeout(Ia(this.D,this),1E3*this.k))};for(var be=0;64>be;++be);var ce=null,jc=function(){return W.oa=!0},kc=function(){W.oa=!0;var a=$d();(a=a&&a.Q)&&ac("googleapis.config/sessionIndex",a);ce||(ce=Q(W,"ss",new ae(de)));a=ce;a.M&&a.M()},de=function(){var a=$d(),b=a&&a.R||null,c=a&&a.t;Ub("auth",{callback:function(){var a=O.gapi.auth,e={client_id:c,session_state:b};a.checkSessionState(e,function(b){var c=e.session_state,h=Y("isLoggedIn");b=Y("debug/forceIm")?!1:c&&b||!c&&!b;if(h=h!=b)ac("isLoggedIn",b),kc(),od(),b||((b=a.signOut)?b():(b=a.setToken)&&b(null));b=
